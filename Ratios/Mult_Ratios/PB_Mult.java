...
/**
 * Calculates and plots multiplicity ratios for Lead (Pb) and Deuterium targets.
 * - Q2, Nu: bin-by-bin multiplicity ratio (proton/electron, Pb/D)
 * - Zh, Pt^2: proton ratio histogram divided by total electron ratio (single number)
 */
public class Ratio_lead {
    public static void main(String[] args) {
        // Initialize HIPO reader and particle bank
        HipoChain reader = Lead_F.getPBChain();
        Event event = new Event();
        Bank particles = new Bank(reader.getSchemaFactory().getSchema("REC::Particle"));

        // Histograms for electrons (Lead and Deuterium)
        H1F hQ2_Pb_e = new H1F("hQ2_Pb_e", 50, 0, 10);
        H1F hQ2_D_e = new H1F("hQ2_D_e", 50, 0, 10);
        H1F hNu_Pb_e = new H1F("hNu_Pb_e", 50, 0, 10);
        H1F hNu_D_e = new H1F("hNu_D_e", 50, 0, 10);
        H1F hZ_Pb_e = new H1F("hZ_Pb_e", 50, 0, 1.2);
        H1F hZ_D_e = new H1F("hZ_D_e", 50, 0, 1.2);
        H1F hPt2_Pb_e = new H1F("hPt2_Pb_e", 50, 0, 2.0);
        H1F hPt2_D_e = new H1F("hPt2_D_e", 50, 0, 2.0);

        // Histograms for protons (Lead and Deuterium)
        H1F hQ2_Pb_p = new H1F("hQ2_Pb_p", 50, 0, 10);
        H1F hQ2_D_p = new H1F("hQ2_D_p", 50, 0, 10);
        H1F hNu_Pb_p = new H1F("hNu_Pb_p", 50, 0, 10);
        H1F hNu_D_p = new H1F("hNu_D_p", 50, 0, 10);
        H1F hZ_Pb_p = new H1F("hZ_Pb_p", 50, 0, 1.2);
        H1F hZ_D_p = new H1F("hZ_D_p", 50, 0, 1.2);
        H1F hPt2_Pb_p = new H1F("hPt2_Pb_p", 50, 0, 2.0);
        H1F hPt2_D_p = new H1F("hPt2_D_p", 50, 0, 2.0);

        // Event counters for normalization
        int count_Pb_e = 0, count_D_e = 0, count_Pb_p = 0, count_D_p = 0;
        ...
        // Compute Pb/D ratios for electrons and protons (bin-by-bin)
        H1F hRatioQ2_e = hQ2_Pb_e.histClone("hRatioQ2_e"); hRatioQ2_e.divide(hQ2_D_e);
        H1F hRatioNu_e = hNu_Pb_e.histClone("hRatioNu_e"); hRatioNu_e.divide(hNu_D_e);

        H1F hRatioQ2_p = hQ2_Pb_p.histClone("hRatioQ2_p"); hRatioQ2_p.divide(hQ2_D_p);
        H1F hRatioNu_p = hNu_Pb_p.histClone("hRatioNu_p"); hRatioNu_p.divide(hNu_D_p);
        H1F hRatioZh_p = hZ_Pb_p.histClone("hRatioZh_p"); hRatioZh_p.divide(hZ_D_p);
        H1F hRatioPt2_p = hPt2_Pb_p.histClone("hRatioPt2_p"); hRatioPt2_p.divide(hPt2_D_p);

        // Total electron ratio for Zh and Pt2 (single number)
        double totalElectronRatio = (double) count_Pb_e / count_D_e;
        ...
        hMultRatioQ2.setTitle("Multiplicity Ratio Pb/D vs Q^{2}");
        ...
        hMultRatioNu.setTitle("Multiplicity Ratio Pb/D vs Nu");
        ...
        hMultRatioZh.setTitle("Multiplicity Ratio Pb/D vs Z_{h}");
        ...
        hMultRatioPt2.setTitle("Multiplicity Ratio Pb/D vs P_{t}^{2}");
        ...
        System.out.println("Proton counts: Lead = " + count_Pb_p + ", Deuterium = " + count_D_p);
    }
}
